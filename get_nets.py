...
class Flatten(nn.Module):
    ...
    def forward(self, x):
        """
        Arguments:
            x: a float tensor: shape [batch_size, c, h, w].
        Returns:
            a float tensor: shape [batch_size, c*h*w].
        """
...
class PNet(nn.Module):
    ...
    def forward(self, x):
        """
        Arguments:
            x: a float tensor: shape [batch_size, 3, h, w].
        Returns:
            b: a float tensor: shape [batch_size, 4, h', w'].
            a: a float tensor: shape [batch_size, 2, h', w'].
        """
        x = self.features(x)
        a = self.conv4_1(x)
        b = self.conv4_2(x)
...
class RNet(nn.Module):
    ...
    def forward(self, x):
        ...
        Arguments:
            x: a float tensor: shape [batch_size, 3, h, w].
        Returns:
            b: a float tensor: shape [batch_size, 4].
            a: a float tensor: shape [batch_size, 2].
        """
        x = self.features(x)
        a = self.conv5_1(x)
        b = self.conv5_2(x)
...
class ONet(nn.Module):
    ...
    def forward(self, x):
        ...
        Arguments:
            x: a float tensor: shape [batch_size, 3, h, w].
        Returns:
            c: a float tensor: shape [batch_size, 10].
            b: a float tensor: shape [batch_size, 4].
            a: a float tensor: shape [batch_size, 2].
        """
        x = self.features(x)
